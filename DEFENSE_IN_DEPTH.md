...
- [ ] Every action pinned to a full commit SHA (`pnpm dlx actions-up`)
...
- [ ] `.github/workflows/release.yml` packs then stages with `pnpm stage publish ./packed/*.tgz --no-git-checks`
